                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="fre-input-field">
                            ...
                            <input class="keyword search" id="s" type="text" name="s" placeholder="<?php _e('Search projects by keyword', ET_DOMAIN);?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="fre-input-field">
                            <label for="project_category" class="fre-field-title"><?php _e('Category', ET_DOMAIN);?></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="fre-input-field fre-budget-field">
                            <label for="budget" class="fre-field-title"><?php _e('Budget', ET_DOMAIN);?> ($)</label>
