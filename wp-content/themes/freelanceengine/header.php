					...
					<?php if ( ! is_user_logged_in() ) { ?>
                        ...
                        <li class="fre-menu-employer dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- <li>
                                        <a href=""><?php _e( 'Pricing Plans', ET_DOMAIN ); ?></a>
                                    </li> -->
                            </ul>
                        </li>
					<?php } else { ?>
						<?php if ( ae_user_role( $user_ID ) == FREELANCER ) { ?>
                            <li class="fre-menu-freelancer">
                                <a href="<?php echo et_get_page_link( "profile" ) . '#tab_project_details' ?>"><?php _e( 'MY WORK', ET_DOMAIN ); ?></a>
                            </li>
						...
						<?php } else { ?>
                            <li class="fre-menu-freelancer dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <!-- <li>
                                            <a href="<?php echo et_get_page_link( "profile" ) . '#tab_project_details' ?>"><?php _e( 'Working Projects', ET_DOMAIN ); ?></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo et_get_page_link( "profile" ) . '#tab_project_details' ?>"><?php _e( 'All Projects Posted', ET_DOMAIN ); ?></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo et_get_page_link( "profile" ) . '#tab_project_details' ?>"><?php _e( 'Disputes', ET_DOMAIN ); ?></a>
                                        </li> -->
                                    <li>
                                        <a href="<?php echo et_get_page_link( "profile" ) . '#tab_project_details' ?>"><?php _e( 'All project posted', ET_DOMAIN ); ?></a>
                                    </li>
                                    <li>
