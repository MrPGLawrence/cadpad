                ...
                <div class="col-md-4">
                    <div class="setting-profile-wrapper <?php echo $user_role; ?>">
                        ...
                        <script>
                            ...
                            items: {
                                src: '<div class="white-popup">You have not confirmed your email yet, please check your email.<br> Also, please remember to update your PayPal email if you have not already done so.</div>',
                                type: 'inline'
                            }
                            });
                            console.log(1);
                        ...
                        <ul class="list-setting">
                            ...
                            <li>
                                <a id="swap-roles" href="" class="display-name" data-role="<?php echo $user_role ?>" data-id="<?php echo $user_ID ?>">
