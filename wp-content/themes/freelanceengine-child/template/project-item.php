...
<li class="project-item project-item-short">
    <div class="project-list-wrap">
        <?php get_template_part('template/project-detail-content' , 'images'); ?>
        <h2 class="project-list-title project-list-title-long">
