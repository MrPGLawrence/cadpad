		...
		<div class="container">
			...
			<div class="fre-authen-wrapper">
				...
				<div class="fre-register-default">
					...
					<h2><?php _e('Sign Up', ET_DOMAIN)?></h2>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="register-employer">
									...
									<h3><?php _e('User', ET_DOMAIN);?></h3>

									<p><?php _e('Post projects, find 3D Designers and hire them to work.', ET_DOMAIN);?></p>

									<a class="fre-small-btn" href="?role=employer"><?php _e('Sign Up', ET_DOMAIN);?></a>
							...
							<div class="col-sm-6">
								...
								<div class="register-freelancer">
									...
									<h3><?php _e('Designer', ET_DOMAIN);?></h3>

									<p><?php _e('Create a professional profile and find 3D modelling work.', ET_DOMAIN);?></p>

									<a class="fre-small-btn" href="?role=freelancer"><?php _e('Sign Up', ET_DOMAIN);?></a>
				...
				<div class="fre-authen-wrapper">
					...
					<div class="fre-authen-register">
						...
						<?php if($role == 'employer'){ ?>
								...
								<h2><?php _e('Sign Up User Account', ET_DOMAIN);?></h2>

						<?php }else{ ?>

								<h2><?php _e('Sign Up Designer Account', ET_DOMAIN);?></h2>
